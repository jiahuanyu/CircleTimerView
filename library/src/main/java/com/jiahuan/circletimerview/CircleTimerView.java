...
public class CircleTimerView extends View
{
	...
	private static final float DEFAULT_CIRCLE_BUTTON_SHADOWN_RADIUS = 2;
	private static final float DEFAULT_CIRCLE_BUTTON_SHADOWN_X_OFFSET = 0;
	private static final float DEFAULT_CIRCLE_BUTTON_SHADOWN_Y_OFFSET = 0;
	...
	private static final int DEFAULT_TIMER_COLOIN_COLOR = 0x80FA7777;
	...
	private void initialize()
	{
		...
		shadowRadius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CIRCLE_BUTTON_SHADOWN_RADIUS, getContext().getResources().getDisplayMetrics());
		shadowXOffset = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CIRCLE_BUTTON_SHADOWN_X_OFFSET, getContext().getResources().getDisplayMetrics());
		shadowYOffset = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CIRCLE_BUTTON_SHADOWN_Y_OFFSET, getContext().getResources().getDisplayMetrics());
		...
		// TimerColonPaint
		timerColonPaint.setColor(DEFAULT_TIMER_COLOIN_COLOR);
